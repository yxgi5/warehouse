...
def main():
    ...
    check("首图不能上移", repo.move_image(conn, first_id, "up") is False)
    check("尾图不能下移", repo.move_image(conn, img_full[-1][0], "down") is False)
    ok_move = repo.move_image(conn, img_full[1][0], "up")   # 第二张上移
