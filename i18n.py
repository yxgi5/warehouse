...
TRANSLATIONS = {
    "zh": {
        ...
        "items.hint_no_selection": "💡 点击行首的复选框可选中整行（支持 Ctrl 多选），选中后下方工具栏可用",
        "items.hint_one": "✅ 已选中 1 件，可查看详情、编辑或删除",
        "items.hint_many": "✅ 已选中 {n} 件，可批量删除或导出",
        "items.hint_need_one": "请先在表格中选择一行",
        "items.hint_need_select": "请先在表格中选择物品",
        ...
        "containers.hint_no_selection": "💡 点击行首的复选框可选中容器，选中后工具栏可用",
    ...
    "en": {
        ...
        "items.hint_no_selection": "💡 Click the checkboxes to select rows (Ctrl for multi-select), then use the toolbar below",
        "items.hint_one": "✅ 1 item selected — view, edit or delete",
        "items.hint_many": "✅ {n} items selected — batch delete or export",
        "items.hint_need_one": "Select exactly one row in the table first",
        "items.hint_need_select": "Select rows in the table first",
        ...
        "containers.hint_no_selection": "💡 Click the checkboxes to select containers, then use the toolbar",
