...
TRANSLATIONS = {
    "zh": {
        ...
        "common.no_date_help": "勾选则保存时购买日期留空",
        "items.f_tags": "**标签**",
        "items.f_features": "**特点**",
    ...
    "en": {
        ...
        "items.img_shared_at": "📷 Image {n} also used by:",
        ...
        "common.no_date_help": "When checked the purchase date is saved empty",
        "items.f_tags": "**Tags**",
